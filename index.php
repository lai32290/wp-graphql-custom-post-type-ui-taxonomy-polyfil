<?php
/**
* Plugin Name: WPGraphQL Custom Post Type UI Taxonomy Polyfil
* Description: Adds WPGraphQL settings to Custom Post Type UI Taxonomy, this plugin is a polyfil to to add taxonomy support into WP GraphQL
* Author: Henrik Wirth (Extracted by Lai Xuancheng)
* Version: 1.0.0
* Text Domain: wp-graphql-custom-post-type-ui-taxonomy-polyfil
...
*/
class WPGraphQL_CPT_UI_POLYFIL {
	...
	*/
    ...
    /**
	* Set defaults for taxonomy settings
	*/
...
add_action( 'plugins_loaded', 'init_wpgraphql_cptui_polyfil' );
function init_wpgraphql_cptui_polyfil() {
	$wpgraphql_cpt_ui = new WPGraphQL_CPT_UI_POLYFIL ();
